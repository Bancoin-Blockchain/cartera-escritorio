...
const nethash = '971607f461cab714e475106c9577d5be6ca5f203469ce86a5067be4ec4e01813'
...
describe('peer store module', () => {
  ...
  it('should get random seed server peer', () => {
    const randomSeedPeers = store.getters['peer/randomSeedPeers'](5, 'bancoin.mainnet')
    const randomSeedPeers2 = store.getters['peer/randomSeedPeers'](5, 'bancoin.mainnet')
